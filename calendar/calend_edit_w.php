...
//back			if($data[$ii]['sub_tab'] == $uu)
			...
			for($iii = 0;$iii < $nb_display; $iii++)
			{
				...
				echo "<td bgcolor='$cell_color' class='td5'>";
				echo "<input size='10' tabindex='$tab_index' type='text' name='save_data,$savestamp,$item_number,$item_number' value='".$tab[$item_number]['date'.$iii]."'";echo "</td>";
				$tab_index ++;
			}
			echo "</tr>";
			}
...
<div width="930" align="left"> <a href="index.php?toload=calend_edit&calend=<? echo $calend ?>&week_moins=1" > -1 semaine </a></div>
<div width="930" align="center"> <a href="index.php?toload=calend_edit&calend=<? echo $calend ?>&week_now=1" > Cette semaine </a></div>
<div width="930" align="right"> <a href="index.php?toload=calend_edit&calend=<? echo $calend ?>&week_plus=1" > +1 semaine </a></div>
<br></br>