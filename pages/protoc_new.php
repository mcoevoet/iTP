<h3>Insérer un nouveau protocole : </h3>
...
if ((isset($_POST['titre']))&($_POST['titre'] != ""))
{
	...
	if($ok_mysql==1)
	{
		...
		$myquery = "insert INTO protoc_db (titre, doc, descr, cat, add_date) VALUES ('$titre', '$doc', '$descr', '$cat', '$add_date')" ;
		//echo "<br>", $myquery, "<br>" ;
		mysql_query($myquery); 
...
<br>
<br>
<form action="index.php?toload=protoc_new" method="POST" enctype="multipart/form-data">
Titre :<br>
...
<br>
<a href="index.php?toload=protoc_admin_list"> Retour à la liste </a>
<br>
<br>
