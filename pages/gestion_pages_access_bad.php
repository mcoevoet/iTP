...
echo "<tr>";
echo "<td width='220' class='td9'> &nbsp </td> <td width='120' class='td9'></td> <td width='25' class='td9'> <b>&nbsp </b></td>"; 
...
for ($Compteur1=0 ; $Compteur1 < mysql_numrows($Resultat1) ; $Compteur1++)
{
	...
	echo "<td width='150' class='td9' align='center' colspan=$nbrows>".$fonction."</td>";
	
}
echo "</tr>";

echo "<tr>";
echo "<td class='td9'> Nom du fichier </td> <td class='td9'> Nom d'appel </td> <td class='td9'> <b>&nbsp </b></td>"; 
$myquery1 = "SELECT * FROM users_fonction;";
$Resultat1 = mysql_query($myquery1);
for ($Compteur1=0 ; $Compteur1 < mysql_numrows($Resultat1) ; $Compteur1++)
{
	...
	for ($Compteur2=0 ; $Compteur2 < mysql_numrows($Resultat2) ; $Compteur2++)
	{
		...
		echo "<td width='50'class='td9'>".$level."</td>";
	}
}
echo "</tr>";
...
{	
	echo "<tr>";
    echo "<td width='220' height='20' class='td91'> $file</td>";
	...
	for ($Compteur=0 ; $Compteur < mysql_numrows($Resultat) ; $Compteur++)
	{
		...
		$ID = mysql_result($Resultat , $Compteur , "ID");
  		...
  		echo "<td width='120' height='20' class='td91'> &nbsp $call_name </td>";
  	}
  		if($ID!="")
		{
			echo "<td width='25' height='20' class='td91'><a href='index.php?toload=gestion_pages_mod&page_ID=$ID&directory=$folder'> <IMG src='images/modify.gif' height='16' width='16'> </a></td>";
		}
		else
		{
			echo "<td width='120' height='20' class='td91'> &nbsp </td> <td width='25' height='20' class='td91'><a href='index.php?toload=gestion_pages_new&file_name=$file&directory=$folder'><IMG src='images/add.jpg' height='16' width='16'> </a></td>";
		}			
					...
					for ($Compteur2=0 ; $Compteur2 < mysql_numrows($Resultat2) ; $Compteur2++)
					{
						...
						while($i<count($exploded_access)) 
						{
							...
							{	
       						...
       						if ($auth_ok == "yes")
       						{
       							echo "<td class='td91' width='50' align='center'><a id='$file' title='$test_chain' href=pages/gestion_pages_access_disable.php?call_name=$call_name&acc_chain=$test_chain&acc_folder=$_GET[acc_folder]&file_name=$file><img src='images/enable.jpg'/></a></td>"; 
       						}
       						else
       						{
       							echo "<td class='td91' width='50' align='center'><a id='$file' title='$test_chain' href=pages/gestion_pages_access_enable.php?call_name=$call_name&acc_chain=$test_chain&acc_folder=$_GET[acc_folder]&file_name=$file><img src='images/disable.jpg'/></a></td>"; 
       						}
