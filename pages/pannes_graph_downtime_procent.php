 ...
 */
 ...
 $array_to_display = $_SESSION['histo_downtime_procent_array'];
 
 //$array_to_display = round($array_to_display);
 
 $name_to_display = $_SESSION['histo_downtime_procent_nom'];
 ...
 $Test->setFontProperties("../../pChart/Fonts/tahoma.ttf",10);   
 $Test->drawTitle(60,22,"Downtime par mois",50,50,50,585);   
