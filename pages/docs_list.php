...
//echo "test";
	...
	?>
	<a href="index.php?toload=docs_list&selected_cat=all&select_cat=oui">ALL</a>
	<?	
	for ($Compteur=0 ; $Compteur < mysql_numrows($Resultat) ; $Compteur++)
	{
		$cat = mysql_result($Resultat , $Compteur , "cat");
		?>
		<a href="index.php?toload=docs_list&selected_cat=<? echo $cat; ?>&select_cat=oui"><? echo $cat;?></a>
		<?
	}
if($select_cat != "oui")
{
