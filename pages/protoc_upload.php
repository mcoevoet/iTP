...
<?php
$dossier = 'dwld_files/protoc_docs/';
...
//echo $_FILES['doc']['name']."<br>";
//echo $_FILES['doc']['tmp_name']."<br>";
//echo $_FILES['doc']['size']."<br>";
//echo $_FILES['doc']['type']."<br>";
//echo $_FILES['doc']['error']."<br>";
