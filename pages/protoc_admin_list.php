...
//echo "test";
	...
	?>
	<a href="index.php?toload=protoc_admin_list&selected_cat=all&select_cat=oui">ALL</a>
	<?	
	for ($Compteur=0 ; $Compteur < mysql_numrows($Resultat) ; $Compteur++)
	{
		$cat = mysql_result($Resultat , $Compteur , "cat");
		?>
		<a href="index.php?toload=protoc_admin_list&selected_cat=<? echo $cat; ?>&select_cat=oui"><? echo $cat;?></a>
		<?
	}
if($select_cat != "oui")
{
	...
	for ($Compteur=0 ; $Compteur < mysql_numrows($Resultat) ; $Compteur++)
	{
		...
		<tr>
			...
			<td> <a href="index.php?toload=protoc_modif&ID=<? echo $ID; ?>"><img src="images/modify.gif" alt="mod"/></a></td>
			<td align="center"><a href=pages/protoc_delete.php?ID=<? echo $ID ?>><img src="images/delete.jpg" alt="delete"/></a></td>	
		</tr>
...
<br>
<div align="center"> 
<a href=index.php?toload=protoc_new><img src="images/add.jpg" alt="addprotocole" height=32 width=32></a>
</div>
